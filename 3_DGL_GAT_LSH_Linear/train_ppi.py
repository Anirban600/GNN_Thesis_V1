...
from graphsage.utils2 import load_ppi
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        print("\tVal F1-Score: {:.4f} ".format(mean_score), end="")
        # early stop
        if mean_score > best_score or best_loss > mean_val_loss:
            ...
            if cur_step == patience:
                print(f"\tNo more Patience")
                break
        print(f"\tPatience : {cur_step} / {patience}")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num-out-heads", type=int, default=6, help="number of output attention heads")
    ...
    parser.add_argument('--patience', type=int, default=10, help="used for early stop")
