...
## Just a pure mean aggregator for making things easy later on (No need to increase code complexity as above)
class PureMeanAggregator(nn.Module):
    """
    Aggregates a node's embeddings using mean of neighbors' embeddings
    """
    ...
    def __init__(self, features, cuda=False, gcn=False):
        ...
        super(PureMeanAggregator, self).__init__()
